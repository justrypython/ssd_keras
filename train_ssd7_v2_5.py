...
#download_file('ssd_keras_data_2_5_1.tar.gz',cwd+'/ssd_keras_data.tar.gz')
...
scales = [0.02, 0.04, 0.08, 0.16, 0.32] # An explicit list of anchor box scaling factors. If this is passed, it will override `min_scale` and `max_scale`.
...
#uploadgraph = upload_graph(path='zk/results/ssd_keras/v2_5')
#uploadgraph.start()
...
model_path = 'zk/results/ssd_keras/model_v2_5.h5'
model_weights_path = 'zk/results/ssd_keras/weights_v2_5.h5'
