...
#download_file('zk/ssd_keras_data_6_0.tar.gz',cwd+'/ssd_keras_data.tar.gz')
...
n_classes = 9 # Number of classes including the background class
...
history = model.fit_generator(generator = train_generator,
                              ...
                              epochs = epochs,
                              callbacks = [ModelCheckpoint('./ssd7_0_v_ids_6_0_weights_epoch{epoch:02d}_loss{loss:.4f}.h5',
                                                           monitor='val_loss',
                                                           verbose=1,
                                                           save_best_only=True,
...
model_path = 'zk/results/ssd_keras/model_v_ids_6_0.h5'
model_weights_path = 'zk/results/ssd_keras/weights_v_ids_6_0.h5'
